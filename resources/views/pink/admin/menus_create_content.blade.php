...
{!! Form::open(['url' => (isset($menu->id)) ? route('menus.update', $menu->id) : route('menus.store'),'class'=>'contact-form','method'=>'POST','enctype'=>'multipart/form-data']) !!}
	...
	<ul>
		...
		<li class="text-field">
			...
			<div class="input-prepend">
				{!! Form::select('parent', $menus_parent_ids, isset($menu->parent) ? $menu->parent : null) !!}
			 </div>
